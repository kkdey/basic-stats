...
mu <- seq(0.01, 3, length.out=1000)
power <- pnorm(sqrt(65)/2 * mu - 0.644)
...
<<echo=FALSE, eval=TRUE>>=
mu <- seq(0.01, 3, length.out=1000)
power1 <- pnorm(sqrt(25)/2 * mu - 0.644)
plot(mu, power1, type="l", col="red")
power2 <- pnorm(sqrt(65)/2 * mu - 0.644)
lines(mu, power2, col="green")
legend("bottom", 
       legend=c("n=25", "n=65"), 
       col=c("red","green"),
       fill=c("red", "green"),
...
<<echo=FALSE, eval=TRUE>>=
mu <- seq(0.01, 3, length.out=1000)
power1 <- pnorm(sqrt(25)/0.1 * mu - 0.644)
plot(mu, power1, type="l", col="red")
power2 <- pnorm(sqrt(25)/2 * mu - 0.644)
lines(mu, power2, col="green")
legend("bottom", 
       legend=c("sigma=0.1", "sigma=2"), 
       col=c("red","green"),
       fill=c("red", "green"),
       cex=0.5,
       box.lwd=2,
